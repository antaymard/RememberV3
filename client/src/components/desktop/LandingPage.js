  ...
  render() {
    return (
      <div>
          ...
          <div className="mainContainer">
            ...
            <div className="rowFlex firstMarketingDiv">
              <div className="colFlex leftFMD">
                <div className="rowFlex mainRemember" style={{justifyContent : "flex-start"}}>
                  <img className="bigLogo" src={logo}/>
                  <h1>Remember.</h1>
                </div>
                <h1 style={{marginTop : 0}}>More than photos : Memories.</h1>
                <h2>Remember is your private space to keep your memories.</h2>
                <h2>Add deep context to your photos to make them recall a memory in your mind.</h2>
        ...
        <div className="mainContainer">
          <div className='colFlex workingLikeMemoryMarketingDiv'>
            <h2>Works like your memory. Only better.</h2>
          </div>
        </div>

        <div style={{background: "rgba(255,255,255)"}}>
          <div className="colFlex mainContainer featuresMarketingDiv">
        ...
        <div className="mainContainer">
          <div className='colFlex creatingAMemoryMarketingDiv'>
            <h2>Creating a memory is free and easy.</h2>
            <div className='rowFlex'>
              <div className="bubbleDiv">
                <h3>1</h3>
                <p>Add up to 3 photos per memory</p>
              </div>
